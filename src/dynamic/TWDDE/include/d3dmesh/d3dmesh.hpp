...
struct T3MeshEffectPreloadDynamicFeatures
{
  public:
    ...
    int32_t mPriority;
    static constexpr bool IS_BLOCKED = true;
    static constexpr uint64_t GetTypeCRC64(uint64_t crc = 0) { return CRC64_CaseInsensitive("T3MeshEffectPreloadDynamicFeatures", crc); }
};
struct T3MeshEffectPreloadEntry
{
  public:
    ...
    static constexpr bool IS_BLOCKED = true;
    static constexpr uint64_t GetTypeCRC64(uint64_t crc = 0) { return CRC64_CaseInsensitive("T3MeshEffectPreloadEntry", crc); }
};
struct T3MeshEffectPreload
{
  public:
    ...
    static constexpr bool IS_BLOCKED = true;
    static constexpr uint64_t GetTypeCRC64(uint64_t crc = 0) { return CRC64_CaseInsensitive("T3MeshEffectPreload", crc); }
};
...
struct T3OcclusionMeshBatch
{
  public:
    ...
    static constexpr bool IS_BLOCKED = true;
    static constexpr uint64_t GetTypeCRC64(uint64_t crc = 0) { return CRC64_CaseInsensitive("T3OcclusionMeshBatch", crc); }
};
struct T3OcclusionMeshData
{
  public:
    ...
    uint32_t mVertexCount;
    static constexpr bool IS_BLOCKED = false;
    static constexpr uint64_t GetTypeCRC64(uint64_t crc = 0) { return CRC64_CaseInsensitive("T3OcclusionMeshData", crc); }
};
}; // namespace TTH