...
{
  private:
    inline int32_t Read_(Stream &stream) { return stream.Read(this->mSwizzle, sizeof(this->mSwizzle)); }
    inline int32_t Write_(Stream &stream) const { return stream.Write(this->mSwizzle, sizeof(this->mSwizzle)); }
